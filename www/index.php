                ...
                <article>
                    ...
                    <section id="first-step">
                        ...
                        <div id="text1">
                            ...
                            <p>Наше шоу - это небольшая лотерея.  Успей подать заявку за неделю до начала мероприятия. билеты на концерт получают те, кто был выбран беспристрастным рандомом или же поведал нам вескую причину. Подробную информацию можно найти здесь.</p>
                        </div>
                    </section>
                    ...
                    <section id="third-step">
                        ...
                        <div id="text3">
                            ...
                            <p>Мы отправим тебе электронное письмо за день до начала шоу с адресом. Приходи с напитками и выбирай место поудобнее (напольное сидение приветствуется!). Ты не узнаеешь, кто играет, пока не увидишь сам. Возможно, ты откроешь для себя новых любимых исполнителей!
                            </p>
                        </div>
                    </section>
                </article>
